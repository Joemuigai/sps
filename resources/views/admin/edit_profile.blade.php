...
@section('content')
    <div id="content" class="app-content">
        ...
        <ol class="breadcrumb float-xl-end" style="--bs-breadcrumb-divider: '::';" aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.viewStudent', $student->id) }}">{{ $student->first_name . ' ' . $student->last_name }}</a></li>
        ...
        <div class="panel mt-5">
            ...
            <div class="panel-body">
                ...
                <form id='team-head-form' method="POST" action="{{ route('admin.updateProfile', ['member' => $student->id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-15px">
                        ...
                        <div class="col-sm-4">
                            <label class="form-label col-form-label" for="status">Student Member Status <span class="text-danger">*</span></label>
                            <select class="form-select form-select-lg mb-5px @error('status') is-invalid @enderror" name="status" id="status">
                                <option value="">--- Select Student Member Status ---</option>
