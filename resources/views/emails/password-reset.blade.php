                                        ...
                                        <tr>
                                          <td class="pad">
                                            <div style="font-family: sans-serif">
                                              ...
                                              <p style="margin: 0; font-size: 14px; text-align: center; font-family: Arial, Helvetica, sans-serif; color: #555555; line-height: 1.2;">
                                                We have received a request to reset your password for your Smart Parking System account. To ensure the security of your account, please click on the link below to reset your password:
                                              </p>
                                            </div>
                                          </td>
                                        </tr>
